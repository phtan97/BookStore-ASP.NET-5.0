...
namespace BookStoreSolution.Data.Extension
{
    public static class ModelBuilderExtension
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CategoryTranslation>().HasData(
                  new CategoryTranslation() { Id = 1, CategoryId = 1, Name = "Văn học", LanguageId = "vi", SeoAlias = "van-hoc", SeoDescription = "sách văn học việt nam", SeoTitle = "sách văn học việt nam" },
                  new CategoryTranslation() { Id = 2, CategoryId = 2, Name = "Lịch sử", LanguageId = "vi", SeoAlias = "lich-su", SeoDescription = "sách lịch sử việt nam", SeoTitle = "sách lịch sử việt nam" }
                    );
